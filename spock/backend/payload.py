...
from spock.backend.utils import convert_to_tuples
from spock.backend.utils import get_type_fields
from spock.backend.utils import deep_update
...
class AttrPayload(BasePayload):
    ...
    *Attributes*:
    ...
    def _update_payload(base_payload, input_classes, ignore_classes, payload):
        ...
        ignore_fields = {attr.__name__: [val.name for val in attr.__attrs_attrs__] for attr in ignore_classes}
        # Class names
