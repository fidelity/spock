...
# This is a slight fork of the CPython dataclass module. The key difference
# is that the dataclass __init__ only accepts keyword arguments, which
# removes any ambiguity in the resolution order of arguments. This allows
# for non-default attributes to follow default attributes. That is, the following
# is now allowed:
#
# @dataclass
# class Base:
